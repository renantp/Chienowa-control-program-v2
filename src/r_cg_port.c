...
void R_PORT_Create(void) {
	...
	P14 = _01_Pn0_OUTPUT_1 | _00_Pn1_OUTPUT_0 | _00_Pn2_OUTPUT_0
			| _00_Pn6_OUTPUT_0;
	PMC0 = _00_PMCn2_DI_ON | _00_PMCn3_DI_ON | _F3_PMC0_DEFAULT;
	PMC1 = _04_PMCn2_NOT_USE | _08_PMCn3_NOT_USE | _00_PMCn6_DI_ON
			| _00_PMCn7_DI_ON;
	PMC10 = _00_PMCn0_DI_ON | _FE_PMC10_DEFAULT;
	PMC12 = _00_PMCn0_DI_ON | _FE_PMC12_DEFAULT;
	PMC14 = _00_PMCn7_DI_ON | _7F_PMC14_DEFAULT;
	ADPC = _0A_ADPC_DI_ON;
	PM0 = _00_PMn0_MODE_OUTPUT | _02_PMn1_MODE_INPUT | _00_PMn2_MODE_OUTPUT
			| _00_PMn3_MODE_OUTPUT |
			_00_PMn4_MODE_OUTPUT | _20_PMn5_MODE_INPUT | _40_PMn6_MODE_INPUT
			| _80_PM0_DEFAULT;
	...
	PM5 = _00_PMn0_MODE_OUTPUT | _00_PMn1_MODE_OUTPUT | _04_PMn2_MODE_INPUT
			| _08_PMn3_MODE_INPUT |
			_10_PMn4_MODE_INPUT | _00_PMn5_MODE_OUTPUT | _C0_PM5_DEFAULT;
	PM6 = _00_PMn0_MODE_OUTPUT | _00_PMn1_MODE_OUTPUT | _00_PMn2_MODE_OUTPUT
			| _00_PMn3_MODE_OUTPUT |
			_00_PMn4_MODE_OUTPUT | _00_PMn5_MODE_OUTPUT | _00_PMn6_MODE_OUTPUT
			| _00_PMn7_MODE_OUTPUT;
	PM7 = _01_PMn0_MODE_INPUT | _02_PMn1_MODE_INPUT | _04_PMn2_MODE_INPUT
			| _08_PMn3_MODE_INPUT | _10_PMn4_MODE_INPUT |
	...
	PM14 = _00_PMn0_MODE_OUTPUT | _00_PMn1_MODE_OUTPUT | _00_PMn2_MODE_OUTPUT
			| _08_PMn3_NOT_USE | _10_PMn4_NOT_USE |
			_00_PMn6_MODE_OUTPUT | _80_PMn7_MODE_INPUT | _20_PM14_DEFAULT;
	PM15 = _01_PMn0_NOT_USE | _02_PMn1_MODE_INPUT | _04_PMn2_MODE_INPUT
			| _08_PMn3_MODE_INPUT | _F0_PM15_DEFAULT;
}
